  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-gray-100 flex items-center justify-center px-4">
      <motion.div
        ...
        className="max-w-lg w-full bg-white rounded-2xl shadow-xl p-8 text-center border border-red-200"
      >
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
        ...
        >
          <h1 className="text-3xl font-bold text-gray-900 mb-2 flex items-center justify-center gap-2">
            Registration Complete! <PartyPopper className="w-6 h-6 text-red-600" />
          </h1>
